...
if functions.check_plugin("nvim-compe", "opt") then
  ...
  utils.map("n", "<C-f>", ':lua require("lspsaga.action").smart_scroll_with_saga(1)<CR>', opts) -- Control+f: Scroll down documents
  utils.map("n", "<C-b>", ":lua require('lspsaga.action').smart_scroll_with_saga(-1)<CR>", opts) -- Control+b: Scroll up documents
...
utils.map("n", "ZZ", '<cmd>lua require("doom.core.functions").quit_doom(true, true)<CR>', opts)
...
-- Doom
utils.map("n", "<leader>dc", '<cmd>lua require("doom.core.functions").edit_config()<CR>', opts)
...
utils.map("n", "<leader>dR", '<cmd>lua require("doom.core.functions").create_report()<CR>', opts)
...
-- quit / sessions
utils.map("n", "<leader>qq", '<cmd>lua require("doom.core.functions").quit_doom()<CR>', opts)
utils.map(
  "n",
  "<leader>qw",
