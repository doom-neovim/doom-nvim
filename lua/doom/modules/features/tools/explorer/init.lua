...
explorer.configs["nvim-tree.lua"] = function()
  ...
  if is_module_enabled({"features", "languages","lsp"}) then
    override_table = {
      diagnostics = {
        enable = true,
        icons = {
          ...
          warning = doom.features.languages.lsp.settings.icons.warn,
  ...
  }, doom.features.tools.explorer.settings, override_table)
