...
auto_install.packages = {
  ["DAPInstall.nvim"] = {
    ...
    disabled = not is_module_enabled({"features", "tools", "dap"}),
    module = "dap-install",
    disable = true,
  },
  ["nvim-lsp-installer"] = {
    ...
    -- disabled = not is_module_enabled({"features", "languages,"lsp"}),
  },
}
...
auto_install.configs["nvim-lsp-installer"] = function()
  ...
  lsp_installer.settings({
    install_root_dir = doom.features.languages.auto_install.settings.lsp_dir,
  })
end
auto_install.configs["DAPInstall.nvim"] = function()
  local dap_install = require("dap-install")
  dap_install.setup({
    installation_path = doom.features.languages.auto_install.settings.dap_dir,
  })
end
