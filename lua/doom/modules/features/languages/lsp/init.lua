...
lsp.configs["nvim-lspconfig"] = function()
  -- Lsp Symbols
  local signs = {
    Error = doom.features.languages.lsp.settings.icons.error,
    Warn = doom.features.languages.lsp.settings.icons.warn,
    Info = doom.features.languages.lsp.settings.icons.info,
    Hint = doom.features.languages.lsp.settings.icons.hint,
  }
  ...
  vim.diagnostic.config({
    virtual_text = doom.features.languages.lsp.settings.virtual_text,
    severity_sort = doom.features.languages.lsp.settings.severity_sort,
    float = {
      show_header = false,
      border = "rounded",
    },
  ...
  local kinds = {}
  for typ, icon in pairs(doom.features.languages.lsp.settings.completion.kinds) do
...
lsp.configs["nvim-cmp"] = function()
  ...
  luasnip.config.set_config(doom.features.languages.lsp.settings.snippets)
  ...
  doom.features.languages.lsp.settings.sorting = vim.tbl_map(function(comparator)
    return comparators[comparator]
  end, doom.features.languages.lsp.settings.sorting)

  cmp.setup(vim.tbl_deep_extend("force", doom.features.languages.lsp.settings.completion, {
    completeopt = nil,
    completion = {
      completeopt = doom.features.languages.lsp.settings.completion.completeopt,
    },
    formatting = {
      format = function(entry, item)
        item.kind =
          string.format("%s %s", doom.features.languages.lsp.settings.completion.kinds[item.kind], item.kind)
    ...
    mapping = type(doom.features.languages.lsp.settings.completion.mapping) == "function"
        and doom.features.languages.lsp.settings.completion.mapping(cmp)
      or doom.features.languages.lsp.settings.completion.mapping,
    enabled = function()
...
lsp.configs["lsp_signature.nvim"] = function()
  -- Signature help
  require("lsp_signature").setup(vim.tbl_deep_extend("force", doom.features.languages.lsp.settings.signature, {
    handler_opts = {
      border = doom.settings.border_style,
    },
  }))
