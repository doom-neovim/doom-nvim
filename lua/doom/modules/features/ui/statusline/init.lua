...
statusline.configs["heirline.nvim"] = function()
  ...
  local special, special2, special3 = doom.modules.features.ui.statusline._generate_colorscheme()

  local safe_get_highlight = doom.modules.features.ui.statusline._safe_get_highlight
  local colors = {
  ...
  local GitBlock = {
    condition = function()
      local has_gitsigns_module = doom.features.version_control.gitsigns ~= nil
...
statusline.try_refresh = function()
  xpcall(doom.modules.features.ui.statusline.configs["heirline.nvim"], debug.traceback)
end
