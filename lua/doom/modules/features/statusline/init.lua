...
statusline.configs["galaxyline.nvim"] = function()
  ...
  gl.short_line_list = doom.features.statusline.settings.short_line_list

  if is_module_enabled("dashboard") and not doom.features.statusline.settings.on_dashboard then
  ...
  local default_sections = {
    ...
    left = {
      ...
      {
        FileName = {
          provider = doom.features.statusline.settings.show_file_path and "FilePath" or "FileName",
          condition = condition.buffer_not_empty and is_not_dashboard,
  ...
  if is_module_enabled("lsp") then
    table.insert(default_sections.left, {
      DiagnosticError = {
        ...
        condition = is_not_dashboard,
        icon = doom.features.lsp.settings.icons.error .. " ",
        highlight = { colors("red"), colors("bg") },
      },
    })
    table.insert(default_sections.left, {
      DiagnosticWarn = {
        ...
        condition = is_not_dashboard,
        icon = doom.features.lsp.settings.icons.warn .. " ",
        highlight = { colors("orange"), colors("bg") },
      },
    })
    table.insert(default_sections.left, {
      DiagnosticInfo = {
        ...
        condition = is_not_dashboard,
        icon = doom.features.lsp.settings.icons.hint .. " ",
        highlight = { colors("blue"), colors("bg") },
      },
    })
  end

  local merged_sections = vim.tbl_extend("force", default_sections, doom.features.statusline.settings.sections)
