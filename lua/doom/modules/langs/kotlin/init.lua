...
---@eval return doom.core.doc_gen.generate_settings_documentation(MiniDoc.current.eval_section, "langs.kotlin")
kotlin.settings = {
...
---@eval return doom.core.doc_gen.generate_autocmds_documentation("langs.kotlin")
kotlin.autocmds = {
  {
    "FileType",
    "kotlin",
