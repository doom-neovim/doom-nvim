" Vim indent file
" Language: Eel
" Maintainer: molleweide ( https://github.com/molleweide )
" URL: xxx
" Last Change: xxx
...
setlocal indentexpr=GetEelIndent()
...
" GetEelIndent does to find the containing [[{(] (side-effects)
function s:SkipFunc()
  if s:top_col == 1
    throw 'out of bounds'
  elseif s:check_in
